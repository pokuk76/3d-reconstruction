...
class SingleViewRecon(nn.Module):
    def __init__(self, fc_dim=3, fa_dim=256, fs_dim=256, light_dim=27, 
                 cam_dim=12, point_dim=3, num_branch=12, pos_encoding=False,
                 ShapeDecoder=None, AlbedoDecoder=None):
        ...
        if AlbedoDecoder:
            self.AlbedoDecoder = AlbedoDecoder
        else:
...
class SingleViewRecon_(nn.Module):
